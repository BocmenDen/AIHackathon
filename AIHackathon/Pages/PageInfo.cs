...
1.1 Для *Keras*: форма данных будет `[N, 96, 96, 1]`, где `N` — количество изображений.
1.2 Для *Scikit-learn* или *XGBoost*: форма может быть `[N, 96*96]`, где каждое изображение превращается в одномерный вектор длиной 9216 (96 x 96).
