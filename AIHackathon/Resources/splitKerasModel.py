def save_and_split_keras_model(model, output_path, clear_dir=False):
    """
    Сохраняет модель Keras и разбивает на части.

    Args:
        model: Объект модели Keras.
